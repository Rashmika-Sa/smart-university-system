      ...
      <aside className="w-64 shrink-0 bg-white border-r border-gray-100 flex flex-col">
        ...
        <div className="px-6 pt-7 pb-6 border-b border-gray-100">
          <div className="flex items-center gap-2.5 mb-0.5">
            <div className="w-7 h-7 rounded-md bg-[#0d1b3e] flex items-center justify-center">
            ...
            <div>
              <p className="text-[13px] font-bold text-[#0d1b3e] leading-none">SLIIT Smart Uni</p>
              <p className="text-[10px] text-gray-400 tracking-wide uppercase mt-0.5">Facilities</p>
            </div>
          </div>
        </div>

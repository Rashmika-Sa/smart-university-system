...
const CanteenReviews = () => {
  ...
  const [editForm, setEditForm] = useState({ rating: 0, category: 'general', comment: '' });
                        ...
                        {isOwn && (
                          <div className="flex gap-1">
                            <button
                              ...
                              className="text-slate-300 hover:text-blue-400 transition-colors p-1 rounded"
                              title="Edit review"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
            <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
              <h2 className="text-lg font-bold text-slate-900">Edit Review</h2>
              <button
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <StarRow value={editForm.rating} onChange={(val) => setEditForm({...editForm, rating: val})} size="lg" />
              </div>
              <div>
            ...
            <div className="px-6 py-4 border-t border-slate-200 flex gap-3">
              <button
                onClick={() => setEditing(null)}
                className="flex-1 px-4 py-2 bg-slate-100 text-slate-900 rounded-lg font-semibold hover:bg-slate-200 transition"
              >
                Cancel
              </button>
              <button
                onClick={() => handleUpdate(editing)}
                className="flex-1 px-4 py-2 bg-accent text-white rounded-lg font-semibold hover:bg-accent/90 transition"
              >
                Update
              </button>
            </div>

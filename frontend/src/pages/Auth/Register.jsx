...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-[#002b5c] rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob"></div>
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden p-8 border border-gray-100">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-50 text-[#002b5c] mb-4 shadow-sm">
        ...
        <div className="flex justify-between mb-8 px-6 relative">
          ...
          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 border-2 
            ${step >= 1 ? 'bg-[#002b5c] border-[#002b5c] text-white' : 'bg-white border-gray-300 text-gray-400'}`}>
            1
          </div>
          
          {/* Step 2 Indicator */}
          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 border-2 
            ${step >= 2 ? 'bg-[#002b5c] border-[#002b5c] text-white' : 'bg-white border-gray-300 text-gray-400'}`}>
            2
          </div>
          
          {/* Step 3 Indicator */}
          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 border-2 
            ${step >= 3 ? 'bg-[#002b5c] border-[#002b5c] text-white' : 'bg-white border-gray-300 text-gray-400'}`}>
            3
          </div>
        </div>
        ...
        {step === 1 && (
          <form onSubmit={handleSendCode} className="space-y-6 animate-fadeIn">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  className="w-full bg-gray-50 border border-gray-200 rounded-lg py-3 pl-10 pr-4 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#002b5c] focus:border-transparent transition-all"
            ...
            <button disabled={loading} className="w-full bg-[#002b5c] hover:bg-[#004080] text-white font-bold py-3 rounded-lg shadow-md hover:shadow-lg transform transition hover:-translate-y-0.5 flex items-center justify-center gap-2">
        ...
        {step === 2 && (
          <form onSubmit={handleVerifyCode} className="space-y-6 animate-fadeIn">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  maxLength="6"
                  className="w-full bg-gray-50 border border-gray-200 rounded-lg py-3 pl-10 pr-4 text-gray-800 text-center text-2xl tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-[#002b5c] focus:border-transparent transition-all"
                  placeholder="------"
                  value={otp}
            ...
            {/* Verify Button - Updated to SLIIT Blue */}
            <button disabled={loading} className="w-full bg-[#002b5c] hover:bg-[#004080] text-white font-bold py-3 rounded-lg shadow-md hover:shadow-lg transform transition hover:-translate-y-0.5">
              {loading ? 'Verifying...' : 'Verify Code'}
            </button>
            <button type="button" onClick={() => setStep(1)} className="w-full text-gray-500 text-sm hover:text-[#002b5c] transition mt-2">
              Back to Email
            </button>
          </form>
        )}
        ...
        {step === 3 && (
          <form onSubmit={handleRegister} className="space-y-6 animate-fadeIn">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  className="w-full bg-gray-50 border border-gray-200 rounded-lg py-3 pl-10 pr-4 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#002b5c] transition-all"
            ...
            {/* Final Register Button - Updated to SLIIT Blue */}
            <button disabled={loading} className="w-full bg-[#002b5c] hover:bg-[#004080] text-white font-bold py-3 rounded-lg shadow-md hover:shadow-lg transform transition hover:-translate-y-0.5">
        ...
        <div className="mt-8 text-center text-sm text-gray-500 border-t border-gray-100 pt-4">
          ...
          <Link to="/login" className="text-[#002b5c] hover:text-[#004080] font-semibold transition">
            Log In
          </Link>
        </div>

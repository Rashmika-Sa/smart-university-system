  ...
  <div className="space-y-1.5">
    ...
    <div className="relative group">
      <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
        <svg
          className="w-4 h-4 text-slate-500 group-focus-within:text-cyan-400 transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl p-8">
                ...
                <div key={num} className="flex flex-col items-center gap-1.5 z-10">
                  <div
                    ...
                    ${
                        ...
                        ? "bg-cyan-400 border-cyan-400 text-slate-950 shadow-[0_0_15px_rgba(34,211,238,0.6)]"
                        : current
                  ...
                  <span
                    className={`text-[10px] font-semibold uppercase tracking-wider transition-colors ${current ? "text-cyan-400" : done ? "text-slate-500" : "text-slate-700"}`}
                  >
                    {label}
                  </span>
                </div>
          ...
          {error && (
            <div className="mb-5 flex items-center gap-3 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm">
              <span className="shrink-0 w-5 h-5 rounded-full bg-red-500/20 flex items-center justify-center text-xs font-bold">
                !
              </span>
              {error}
            </div>
